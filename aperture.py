...
class Circle(Aperture):
	...
	def __init__(self, background=500, d=200, D = 0.01, scale = 0.01/200):
		...
		self.__aper__[int(n/2-d/2):int(n/2-d/2+d),int(n/2-d/2):int(n/2-d/2+d)] = aper1
...
class DoubleCircle(Aperture):
	def __init__(self, background=500, d=50, D=0.01, separation = 100, scale=0.01/200):
		...
		aper1 = __tools__.circle_aperture(d)
		self.__aper__[int(n/2-d/2):int(n/2-d/2+d),int(n/2-s/2-d/2):int(n/2-s/2+d/2)] = aper1
		self.__aper__[int(n/2-d/2):int(n/2-d/2+d),int(n/2+s/2-d/2):int(n/2+s/2+d/2)] = aper1
...
class Ring(Aperture):
	def __init__(self, background=500, outside=200, inside=100, scale=0.01/200):
		...
		aper2[int(outside/2-inside/2):int(outside/2-inside/2+inside),int(outside/2-inside/2):int(outside/2-inside/2+inside)] = -1*(aper1-1)
		self.__aper__[int(n/2-outside/2):int(n/2-outside/2+outside),int(n/2-outside/2):int(n/2-outside/2+outside)] = aper2
...
class Rectangle(Aperture):
	def __init__(self, background=500, height=200, width=200, scale=0.01/200):
		...
		self.__aper__ = __np__.zeros([n,n])
		self.__aper__[int(n/2-height/2):int(n/2-height/2+height),int(n/2-width/2):int(n/2-width/2+width)] = aper1
...
class DoubleRectangle(Aperture):
	def __init__(self, background=500, height=50, width=2, separation=4, scale=0.01/200):
		...
		self.__aper__ = __np__.zeros([n,n])
		aper1 = __np__.ones([height,width])
		self.__aper__[int(n/2-height/2):int(n/2-height/2+height),int(n/2-width/2-separation/2):int(n/2-width/2+width-separation/2)] = aper1
		self.__aper__[int(n/2-height/2):int(n/2-height/2+height),int(n/2-width/2+separation/2):int(n/2-width/2+width+separation/2)] = aper1
...
class Frame(Aperture):
	def __init__(self, background=500, outside=200, inside=100, scale=0.01/200):
		...
		self.__aper__[int(n/2-outside/2):int(n/2-outside/2+outside),int(n/2-outside/2):int(n/2-outside/2+outside)] = aper1
		self.__aper__[int(n/2-inside/2):int(n/2-inside/2+inside),int(n/2-inside/2):int(n/2-inside/2+inside)] = aper2
